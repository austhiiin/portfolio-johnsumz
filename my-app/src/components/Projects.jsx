...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      id: 2,
      title: "Deimint Admin",
      subtitle: "Artist Commission Admin Panel",
      description:
        "A dedicated admin dashboard for managing Deimint's digital and traditional art commissions. Provides a streamlined interface to track orders, manage commission statuses, and oversee client requests.",
      longDescription:
        "An admin panel built specifically for the Deimint artist brand to manage the full commission workflow. Features include commission tracking, order management, and a clean dashboard UI designed for efficient day-to-day artist operations. Deployed on Vercel for fast, reliable access.",
      category: "Web App",
      tech: ["React", "Vite", "Vercel", "CSS"],
      liveUrl: "https://deimint-admin.vercel.app",
      githubUrl: null,
      ...
      year: "2025",
      image: null,
      gradient: "from-rose-500/20 via-pink-500/10 to-slate-900",
    },
    {
      id: 3,
      title: "Deimint Portfolio",
      subtitle: "Digital & Traditional Artist Portfolio",
      description:
        "A personal portfolio website for Deimint, a digital and traditional artist with open commissions. Showcases artwork, commission information, and provides a platform for potential clients to connect.",
      longDescription:
        "A beautifully crafted portfolio site for Deimint, a digital and traditional artist. The site highlights their artwork gallery, commission availability, and contact details — designed to attract clients and showcase creative work with an aesthetic that reflects the artist's style. Deployed on Vercel.",
      category: "Portfolio",
      tech: ["React", "Vite", "Vercel", "CSS"],
      liveUrl: "https://deimint-portfolio.vercel.app",
      githubUrl: null,
      ...
      year: "2025",
      image: null,
      gradient: "from-violet-500/20 via-fuchsia-500/10 to-slate-900",
    },
  ];
